...
func (scbuilder *SiteConfigBuilder) getPaoManifest() (string, interface{}) {
	paoValue := scbuilder.fHandler.ReadSourceFileCR(paoSubPath + "/" + paoSubFile)
	paoMap := string(paoValue)

	return paoSubFile, reflect.ValueOf(paoMap).Interface()
}
